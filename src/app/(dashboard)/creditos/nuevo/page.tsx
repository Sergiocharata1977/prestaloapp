  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-slate-900">Nuevo crédito</h2>
      ...
      {step === 1 && (
        <div className="grid gap-6 lg:grid-cols-2">
            ...
            <CardContent>
              <form onSubmit={goToStep2} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(v) => setValue("sucursal_id", v)}
                    defaultValue={currentValues.sucursal_id}
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  {errors.articulo_descripcion && (
                    <p className="text-xs text-red-600">{errors.articulo_descripcion.message}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setValue("sistema", v as "frances" | "aleman")}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="space-y-2">
                    ...
                    {errors.capital && (
                      <p className="text-xs text-red-600">{errors.capital.message}</p>
                    )}
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.fecha_primer_vencimiento && (
                      <p className="text-xs text-red-600">{errors.fecha_primer_vencimiento.message}</p>
                    )}
                  </div>
                </div>
          ...
          {/* Preview */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-slate-600">Vista previa tabla de amortización</h3>
      ...
      {step === 2 && tabla && (
        <div className="max-w-2xl space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Confirmar crédito</CardTitle>
            </CardHeader>
